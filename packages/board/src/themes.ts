/**
 * Per-component-type accents for Board.
 *
...
// how a pane states what it is, so "yellow = Agent" has to hold in every
...
export const PANE_HEADER_CLASS =
  "h-8 shrink-0 select-none border-b border-swarm-border/40 glass-toolbar flex items-center gap-1.5 px-2 cursor-grab active:cursor-grabbing " +
 ...
 * Flow canvas drags a node by — without it, dragging anywhere in a pane
