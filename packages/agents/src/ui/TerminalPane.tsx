...
export default function TerminalPane({
 ...
 // Cleanup the copied timeout when the component unmounts, and guard
 // setState with a mounted ref so a late timer tick doesn't call setState
 ...
 setCopied(true);
 copiedTimeoutRef.current = setTimeout(() => { if (mountedRef.current) setCopied(false); }, 1800);
 }
 }
 };
