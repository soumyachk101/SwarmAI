...
type ModalTabId = "guide" | "privacy";
const TABS: Array<{ id: ModalTabId; label: string }> = [
 { id: "guide", label: "User Guide" },
 { id: "privacy", label: "Privacy & Security" },
];

export default function UserGuideModal({ isOpen, onClose }: UserGuideModalProps) {
 const [activeTab, setActiveTab] = useState<ModalTabId>("guide");
 ...
 setSelectedTopic(nextTab.id === "guide" ? "quickstart" : "local-first");
 ...
 role="dialog"
 aria-modal="true"
 aria-label={activeTab === "guide" ? "Swarm AI User Guide" : "Privacy Policy"}
 className="relative flex flex-col w-full max-w-4xl max-h-[85vh] rounded-2xl bg-swarm-surface/98 backdrop-blur-2xl border border-swarm-borderHi/40 shadow-2xl shadow-black/90 overflow-hidden"
 >
 {/* Header */}
 ...
 className="flex items-center rounded-lg bg-swarm-canvas/60 p-0.5 border border-swarm-border/80 text-xs"
 >
 {TABS.map((tab) => {
 ...
 onClick={() => {
 setActiveTab(tab.id);
 setSelectedTopic(tab.id === "guide" ? "quickstart" : "local-first");
 }}
 ...
 aria-current={selectedTopic === "quickstart" ? "page" : undefined}
 ...
 aria-current={selectedTopic === "lead" ? "page" : undefined}
 className={`flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs transition-colors text-left cursor-pointer ${
 selectedTopic === "lead"
 ? "bg-swarm-surfaceHi text-swarm-text font-semibold border border-swarm-borderHi/40"
 : "text-swarm-textDim hover:bg-swarm-surfaceHi/40 hover:text-swarm-text"
 ...
 aria-current={selectedTopic === "canvas" ? "page" : undefined}
 className={`flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs transition-colors text-left cursor-pointer ${
 ...
 aria-current={selectedTopic === "worktrees" ? "page" : undefined}
 className={`flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs transition-colors text-left cursor-pointer ${
 ...
 aria-current={selectedTopic === "shortcuts" ? "page" : undefined}
 className={`flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs transition-colors text-left cursor-pointer ${
 ...
 aria-current={selectedTopic === "local-first" ? "page" : undefined}
 className={`flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs transition-colors text-left cursor-pointer ${
 ...
 aria-current={selectedTopic === "keychain" ? "page" : undefined}
 className={`flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs transition-colors text-left cursor-pointer ${
 ...
 aria-current={selectedTopic === "scrubbing" ? "page" : undefined}
 className={`flex items-center gap-2 px-2.5 py-2 rounded-lg text-xs transition-colors text-left cursor-pointer ${
 ...
 <tr>
 <th scope="col" className="p-2">Shortcut</th>
