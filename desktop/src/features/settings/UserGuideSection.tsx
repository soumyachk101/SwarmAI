...
type SubTabId = "overview" | "lead" | "flow" | "worktrees" | "clis" | "shortcuts";
...
export default function UserGuideSection() {
 ...
 const nextIndex =
 e.key === "ArrowRight"
 ? (index + 1) % SUB_TABS.length
 : (index - 1 + SUB_TABS.length) % SUB_TABS.length;
 ...
 {activeSubTab === "lead" && (
 <div
 id="subtab-panel-lead"
 role="tabpanel"
 aria-labelledby="subtab-lead"
 className="flex flex-col gap-3 animate-fade-in"
 >
 ...
 {activeSubTab === "flow" && (
 <div
 id="subtab-panel-flow"
 role="tabpanel"
 aria-labelledby="subtab-flow"
 className="flex flex-col gap-3 animate-fade-in"
 >
 <h4 className="font-bold text-swarm-text flex items-center gap-2">
 ...
 <div
 id="subtab-panel-worktrees"
 role="tabpanel"
 aria-labelledby="subtab-worktrees"
 className="flex flex-col gap-3 animate-fade-in"
 >
 <h4 className="font-bold text-swarm-text flex items-center gap-2">
 ...
 {activeSubTab === "clis" && (
 <div
 id="subtab-panel-clis"
 role="tabpanel"
 aria-labelledby="subtab-clis"
 className="flex flex-col gap-3 animate-fade-in"
 >
 <h4 className="font-bold text-swarm-text flex items-center gap-2">
 ...
 <p className="text-[11px] text-swarm-textMuted mt-0.5">
 Full 1M Opus context support. Normalizes <code>/effort low</code>, <code>medium</code>, <code>high</code>, <code>xhigh</code>, and <code>ultracode</code> arguments automatically.
 </p>
 </div>
 ...
 <p className="text-[11px] text-swarm-textMuted mt-0.5">
 Connects to local Ollama / vLLM servers running DeepSeek R1 671B,  2.5 Coder, and LLaMA 3.3 for 100% air-gapped coding.
 </p>
 </div>
 </div>
 </div>
 ...
 <div
 id="subtab-panel-shortcuts"
 role="tabpanel"
 aria-labelledby="subtab-shortcuts"
 className="flex flex-col gap-3 animate-fade-in"
 >
 <h4 className="font-bold text-swarm-text flex items-center gap-2">
 ...
 <th scope="col" className="p-2">Action Description</th>
 </tr>
 </thead>
